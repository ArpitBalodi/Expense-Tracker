...
function add_expense(){
    ...
    if(amount && date && note && selected){
     ...
     alert("Successfully added expensed");
...
function add_category(){
    var new_category_value = document.getElementsByName("new-category")[0].value;
     if(new_category_value){
        ...
        var available_catagories = document.getElementsByClassName("available_catagories")[0];
        ...
        available_catagories.appendChild(new_category_span);
